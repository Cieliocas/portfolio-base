...
export function CyberNav() {
  ...
  return (
    <>
      <nav className={`nav-dock transition-all duration-300 ${scrolled ? 'nav-hidden' : ''}`}>
      ...
      <nav className={`quick-dock transition-all duration-300 ${scrolled ? 'quick-dock-visible' : ''}`} aria-label="Menu rapido">
